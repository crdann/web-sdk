...
import { SYMBOL_SIZE, SYMBOL_SPACING_X, SYMBOL_SPACING_Y, REEL_PADDING, SYMBOL_INFO_MAP, BOARD_DIMENSIONS } from './constants';
...
// other utils
export const getSymbolX = (reelIndex: number) => SYMBOL_SIZE * SYMBOL_SPACING_X * (reelIndex + REEL_PADDING);
export const getSymbolY = (symbolIndexOfBoard: number) => (symbolIndexOfBoard + 0.5) * SYMBOL_SIZE * SYMBOL_SPACING_Y;
